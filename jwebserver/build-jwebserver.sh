...
docker run --rm -d --name jwebserver.jvm jwebserver.jvm:latest
sleep 1
...
docker run --rm -d --name jwebserver.static jwebserver.static:latest
sleep 1
curl http://172.17.0.2:8000/index.html
curl http://172.17.0.2:8000/get_simple_1.json
...
docker run --rm -d --name jwebserver.upx jwebserver.upx:latest
sleep 1
curl http://172.17.0.2:8000/index.html
curl http://172.17.0.2:8000/get_simple_1.json
